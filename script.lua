...
getgenv().TextColorChange = Color3.fromRGB(255, 0, 0)
...
-- ui -- 
local ui = game:GetService("CoreGui"):FindFirstChild("King Free Hub | Blox Fruit")
if ui then
   ui:Destroy()
end
-- init
...
local lib = library.new("King Free Hub | Blox Fruit")
...
local CD = 0.00000000000000000 -- time to next attack
...
spawn(function()
   while game:GetService("RunService").RenderStepped:wait(0) do
...
AutofarmSetting:addToggle("Fast Atack",getgenv().FastAttack, function(x)
...
games:addButton("Copy Discord Server(Join or gay)",function()
   setclipboard("https://discord.gg/XDvHEhPFgQ")
end)
         ...
         pcall(function()
            repeat
               ...
               for i, v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                  ...
                  if v.Name ~= "Ice Admiral [Lv. 700] [Boss]" and v.Name ~= "Saber Expert [Lv. 200] [Boss]" and (v.HumanoidRootPart.Position-game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position).magnitude <= getgenv().MagnetDistance and not Tweening and v.Name == MobsPick then
                     v.Humanoid:ChangeState(11)
                     v.Humanoid.PlatformStand = true
                     v.HumanoidRootPart.Transparency = 1
                     v.HumanoidRootPart.CanCollide = false
         ...
         pcall(function()
            repeat
               ...
               for i, v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                  ...
                  if v.Name ~= "Ice Admiral [Lv. 700] [Boss]" and v.Name ~= "Saber Expert [Lv. 200] [Boss]" and (v.HumanoidRootPart.Position-game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position).magnitude <= getgenv().MagnetDistance and not Tweening and v.Name == Ms then
                     v.Humanoid:ChangeState(11)
                     v.Humanoid.PlatformStand = true
                     v.HumanoidRootPart.Transparency = 1
                     v.HumanoidRootPart.CanCollide = false
